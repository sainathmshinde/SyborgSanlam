            ...
            <div className={cn("flex-1")}>
              <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                ...
                >
                  ...
                  >
                    <path
                      d="M15.7778 19.9998V17.8887C15.7778 16.7689 15.3329 15.695 14.5411 14.9032C13.7493 14.1113 12.6754 13.6665 11.5556 13.6665H5.22222C4.10242 13.6665 3.02848 14.1113 2.23666 14.9032C1.44484 15.695 1 16.7689 1 17.8887V19.9998"
                      stroke="#2E3748"
                      stroke-width="2"
                    ...
                    />
                    <path
                      d="M8.38897 9.44444C10.7208 9.44444 12.6112 7.55409 12.6112 5.22222C12.6112 2.89035 10.7208 1 8.38897 1C6.0571 1 4.16675 2.89035 4.16675 5.22222C4.16675 7.55409 6.0571 9.44444 8.38897 9.44444Z"
                      stroke="#2E3748"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                >
                  ...
                  >
                    <path
                      d="M11.9595 24H10.7405C6.1497 24 3.85315 24 2.426 22.6522C1 21.3055 1 19.1366 1 14.8V10.2C1 5.86335 1 3.69445 2.426 2.3478C3.85315 1 6.1497 1 10.7405 1H11.9595C16.5515 1 18.8469 1 20.274 2.3478C21.7 3.69445 21.7 5.86335 21.7 10.2V10.775M6.75 6.75H15.95M6.75 12.5H12.5"
                      stroke="#2E3748"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M19.4 23.9999V22.521C18.7749 22.5254 18.1581 22.378 17.6025 22.0916C17.0468 21.8052 16.569 21.3882 16.2099 20.8765M19.4 22.5199C20.0252 22.5242 20.642 22.3769 21.1976 22.0905C21.7532 21.804 22.2311 21.3871 22.5901 20.8754M19.4 15.1277C20.7306 15.1277 21.9024 15.7809 22.5901 16.7722C23.0091 17.3738 23.2338 18.0906 23.2338 18.8238C23.2338 19.5569 23.0091 20.2725 22.5901 20.8742L24 21.7804M16.2099 16.7745C16.569 16.2627 17.0468 15.8458 17.6025 15.5593C18.1581 15.2729 18.7749 15.1256 19.4 15.13V13.6499M24 15.8683L22.5901 16.7745M14.8 21.7804L16.2099 20.8742C15.7909 20.2725 15.5663 19.5569 15.5663 18.8238C15.5663 18.0906 15.7909 17.375 16.2099 16.7733M14.8 15.8694L16.2099 16.7756"
                      stroke="#2E3748"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <div className={cn("flex-1")}>
              <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                ...
                >
                  ...
                  >
                    <path
                      d="M10.5556 6.33333V0H19V6.33333H10.5556ZM0 10.5556V0H8.44444V10.5556H0ZM10.5556 19V8.44444H19V19H10.5556ZM0 19V12.6667H8.44444V19H0Z"
                      fill="#2E3748"
                    />
                  </svg>
                  Dashboard
