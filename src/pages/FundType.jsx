...
const fundTypes = [
  {
    ...
    name: "Equity",
    description:
      "Type of investment fund that primarily invests in stocks or shares of companies.",
  },
  {
    id: 2,
    name: "Money market",
    description:
      "Type of mutual fund that invests in short-term, low-risk, and highly liquid financial instruments.",
  },
  {
    id: 4,
    name: "Balanced",
    description:
      "Type of mutual fund that invests in a mix of different asset classes, such as stocks, bonds, and sometimes other investments like cash or real estate. ",
  },
  {
    id: 5,
    name: "Property",
    description:
      "Type of investment fund that primarily invests in real estate properties or real estate-related assets. ",
  },
];
